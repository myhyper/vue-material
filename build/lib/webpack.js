...
function setComponentsConfig(entries, output) {
  ...
  componentList.forEach((component) => {
    const isSharable = existsSync(
      resolvePath(componentsPath, component, "index.js")
    );

    if (isSharable) {
      entries[join("components", component, "index")] = [
        `./${join(componentsPath, component)}/index`,
      ];
    }
  });
          ...
          rules: [
            {
              ...
              options: {
                ...
                postcss: [autoprefixer(), mediaPacker()],
              },
              exclude: /node_modules/,
            },
            {
